...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var jelly__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! jelly */ "./src/js/jelly.js");
...
smooth_scrollbar__WEBPACK_IMPORTED_MODULE_1__["default"].use(vendor_smooth_scrollbar_SoftScrollPlugin__WEBPACK_IMPORTED_MODULE_2__["default"]);// Init smooth scrollbar
var view=document.getElementById('view-main');var scrollbar=smooth_scrollbar__WEBPACK_IMPORTED_MODULE_1__["default"].init(view,{renderByPixels:false,damping:0.075});// Init Jelly and provide smooth scrollbar offset
var jelly=new jelly__WEBPACK_IMPORTED_MODULE_0__["default"]({scrollPos:function scrollPos(){return scrollbar.offset.y;}});// Optional demo: pause when scroll via scrollbar track
scrollbar.track.yAxis.element.addEventListener('mousedown',function(){jelly.pause(true);});document.documentElement.addEventListener('mouseup',function(){jelly.pause(false);},true);
